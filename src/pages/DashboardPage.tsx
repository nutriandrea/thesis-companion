...
export default function DashboardPage() {
  const { roadmap, toggleTask, currentStudent } = useApp();
  ...
  const totalDays = 199; // Mar 1 to Sep 15
  const elapsedDays = 17; // as of Mar 18
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold font-display">Ciao, {currentStudent.firstName} 👋</h1>
